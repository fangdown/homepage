  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <form onSubmit={handleLogin} className="bg-white p-8 rounded-lg border w-80">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h2 className="text-xl font-bold mb-4">{editingProject ? '编辑作品' : '添加作品'}</h2>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-1">预览链接</label>
                <input
                  type="url"
              ...
              <div className="flex justify-end gap-2">
                ...
                >
                  {isSubmitting ? '处理中...' : editingProject ? '保存' : '添加'}
                </button>
              </div>
            </form>
          </div>
